---
name: email-receiver-map
generated-from: email-receiver:46c6086746cddb588ed5d86428ac8d8b4d8695c6
paths: [src/, src/handlers/, src/parsers/]
description: email-receiver dispatcher/handler 構造ナビ。dtako handler・subject parser (NFKC 正規化)・silent drop 規約・GitHub Packages 配布・CI/deploy フロー等のアーキテクチャ詳細を収録。
---
# email-receiver-map — 構造ナビゲーション
